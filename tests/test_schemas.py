...
from backend.schemas import (
    ...
    DashboardCreateRequest, ChartType,
    SessionCreateResponse, SchemaResponse,
    HealthCheckResponse, SavedQuery
)
...
class TestAnalyzeResponse:
    ...
    def test_empty_data_allowed(self):
        ...
        resp = AnalyzeResponse(
            generated_sql="SELECT * FROM empty_table",
            data=[],
            row_count=0
        )
...
class TestErrorResponse:
    ...
    def test_error_with_sql(self):
        ...
        resp = ErrorResponse(
            ...
            suggestion="Check spelling of 'FROM'"
        )
