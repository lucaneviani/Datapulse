...
TABLE_ALIASES = {"c": "customers", "p": "products", "o": "orders", "oi": "order_items"}
...
def validate_sql_dynamic(sql: str) -> tuple[bool, str]:
    ...
    forbidden_keywords = [
        ...
        "LOAD_FILE",
        "INTO OUTFILE",
        "INTO DUMPFILE",  # MySQL file ops
        "COPY",
        "\\\\COPY",  # PostgreSQL file ops
        "XP_",
        "SP_",  # SQL Server system procs
        "UTL_",
...
def get_cache_stats() -> dict:
    ...
    return {"size": len(sql_cache.cache), "max_size": sql_cache.max_size, "ttl_seconds": sql_cache.ttl.total_seconds()}
